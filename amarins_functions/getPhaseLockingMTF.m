function [phase2,VS2,RG]=getPhaseLockingMTF(sst,trials)
...
freq=sst.Epocs.Values.mfr1(trials(1));
...
% get response gain in dB
if isnan(VS2)
    RG=NaN;
else
    RG=20*log10((200*VS2)/sst.Epocs.Values.mdp1(trials(1))); 
end
...
% dep=(sst.Epocs.Values.mdp1(trials(1)))/100;
